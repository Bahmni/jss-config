...
SET @parent_location_id = (select location_id from location where name='Ward 1A');
insert into location_tag_map values( @parent_location_id , @location_tag_id);

insert into location (name, description, creator, retired, date_created, uuid, parent_location) values('Ward 1A Physical Location', 'Ward 1A Physical Location', 1, 0, NOW(), UUID(), @parent_location_id);
SET @location_id = (select location_id from location where name='Ward 1A Physical Location');
...
SET @parent_location_id = (select location_id from location where name='New OPD');
insert into location_tag_map values( @parent_location_id , @location_tag_id);

insert into location (name, description, creator, retired, date_created, uuid, parent_location) values('New OPD Physical Location', 'New OPD Physical Location', 1, 0, NOW(), UUID(), @parent_location_id);
SET @location_id = (select location_id from location where name='New OPD Physical Location');
...
SET @parent_location_id = (select location_id from location where name='OPD 5');
insert into location_tag_map values( @parent_location_id , @location_tag_id);

insert into location (name, description, creator, retired, date_created, uuid, parent_location) values('OPD 5 Physical Location', 'OPD 5 Physical Location', 1, 0, NOW(), UUID(), @parent_location_id);
SET @location_id = (select location_id from location where name='OPD 5 Physical Location');
...
SET @parent_location_id = (select location_id from location where name='OPD 6');
insert into location_tag_map values( @parent_location_id , @location_tag_id);


insert into location (name, description, creator, retired, date_created, uuid, parent_location) values('OPD 6 Physical Location', 'OPD 6 Physical Location', 1, 0, NOW(), UUID(), @parent_location_id);
SET @location_id = (select location_id from location where name='OPD 6 Physical Location');
...
SET @parent_location_id = (select location_id from location where name='TB Isolation');
insert into location_tag_map values( @parent_location_id , @location_tag_id);


insert into location (name, description, creator, retired, date_created, uuid, parent_location) values('TB Isolation Physical Location', 'TB Isolation Physical Location', 1, 0, NOW(), UUID(), @parent_location_id);
SET @location_id = (select location_id from location where name='TB Isolation Physical Location');
...
# ANC
insert into location (name, description, creator, retired, date_created, uuid) values('ANC Ward', 'ANC Ward', 1, 0, NOW(), UUID());
SET @parent_location_id = (select location_id from location where name='ANC Ward');
insert into location_tag_map values( @parent_location_id , @location_tag_id);

insert into location (name, description, creator, retired, date_created, uuid, parent_location) values('ANC Physical Location', 'ANC Physical Location', 1, 0, NOW(), UUID(), @parent_location_id);
SET @location_id = (select location_id from location where name='ANC Physical Location');
