...
run_in_vagrant -c "sudo ln -s /Project/jss-config/openmrs/patientMatchingAlgorithm /home/jss/.OpenMRS/patientMatchingAlgorithm"
run_in_vagrant -c "sudo ln -s /Project/jss-config/openmrs/obscalculator /home/jss/.OpenMRS/obscalculator"
